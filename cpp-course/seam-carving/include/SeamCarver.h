...
private:
    Image m_image;
    SeamCarver::Seam FindSeam(const std::vector<std::vector<double>> & energy_sum) const;
    std::vector<std::vector<double>> FindEnergySum(size_t width, size_t height, bool isHorizontal) const;
};